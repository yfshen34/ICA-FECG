function QRSref=QRSdetectorF1(vadx,vdx,Fs,pth,RRts,pmQT)
% --------------------------------------------------------------------------------------------
...
%
%	Example:
%	 qrsF=QRSdetectorF1(vadx,vdx,fs,0.4,0.86,1);
%
% NOTE:
...
% 2008/11  Modified control row 104 (if(i < iinizio+QRSd || i<ifine+nsd))
%
% --------------------------------------------------------------------------------------------
...
if (nargin < 5),  RRts=0.65;  end     % 0.86=human  % 0.25= mouse
